...
<!--- Parámetros --->
<cfset vTituloSistema= 'Comisión de Asuntos Académico-Administrativos'>
		...
		<nav class="navbar navbar-default navbar-static-top">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<cfoutput>
						<div style="float:left;"><img src="https://vectores.cic.unam.mx/images/iconos/sistemas/V2_logo_samaa.png" width="50px" title="SAMAA"></div>
