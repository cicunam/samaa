...
<cfelse>
	...
	<cfif CGI.SERVER_PORT IS "31221">
        <cfif Find("pepe", CGI.SCRIPT_NAME) NEQ 0>
            <cfset vCarpetaRaizLogica = '/samaa/pepe'>
            <cfset vCarpetaRaizLogicaSistema = '/samaa/pepe/app_informes'>
        <cfelseif Find("aram", CGI.SCRIPT_NAME) NEQ 0>
            <cfset vCarpetaRaizLogica = '/samaa/aram'>
            <cfset vCarpetaRaizLogicaSistema = '/samaa/aram/app_informes'>
        </cfif>
        <cfset Application.vCarpetaRaizArchivos = 'E:\archivos_samaa'>
    <cfelse>
        <cfset vCarpetaRaizLogica = '/samaa'>
		<cfset vCarpetaRaizLogicaSistema = '/samaa/app_informes'>
    </cfif>
        
    <!--- RECURSOS GLOBALES --->
    <cfset vHttpWebGlobal = 'http://www.cic.unam.mx:' & #CGI.SERVER_PORT# & '/comun_cic'>
    ...
    <!---
    <cfset vWebCAAA = '#vCarpetaRaizLogicaSistema#/archivos_caaa/'>
    <cfset vWebAcad = '#vCarpetaRaizLogicaSistema#/archivos_academicos/'>
    --->
    <cfset vWebInformesAnuales = '#vCarpetaRaizLogicaSistema#/archivos_academicos_inf_anual/'>    
<!---
...
<!---        
    ...
    <cfset vCarpetaAcad = '#vCarpetaRaizArchivos#\archivos_academicos\'>
--->        
    ...
    <cfif IsDefined('Session.sLoginSistema') AND IsDefined('Session.sTipoSistema')>
    	<cfif #Session.sLoginSistema# NEQ 'caaa' AND #Session.sTipoSistema# NEQ 'samaa_caaa'>
			<cflocation url="#vCarpetaRaizLogica#/valida/invalido.cfm?vError=Restringe" addtoken="no">
		</cfif>            
	<cfelse>
		<cflocation url="#vCarpetaRaizLogica#/valida/invalido.cfm?vError=Restringe" addtoken="no">
