...
<cfelse>
	...
	<cfset vLigaInformacionAcad = 'http://#CGI.SERVER_NAME#:#CGI.SERVER_PORT#/consultas/academicos/valida_academico.cfm'>    
	<cfset vTipoInput = 'hidden'>
</cfif>
...
<cfelse>
	...
	<cferror type="exception" template="#Application.vCarpetaRaizLogica#/error.cfm" mailto="aramp@unam.mx" exception="any">
</cfif>
--->