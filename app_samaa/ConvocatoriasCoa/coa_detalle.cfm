...
<script language="JavaScript" type="text/JavaScript">    
    ...
    function jsfActualizaEntStatus(vSolInput, vSolId)
    {
        ...
        $.ajax({
            ...
            type:'GET',
            data: {vpSolId: vSolId, vpSolInput: vSolInput, vpSolInputVal: $('#'+vSolId+'_'+vSolInput).val()},
            contentType: false,
            success: function(data) {
                //alert('SE ACTUALIZÓ'+data);
                /*
                $.confirm({
...
--->
        ...
        <cfoutput query="tbCoaDocs">
            ...
            <div class="row h5">
                <div class="#vColDE1#">#presdoc_descrip#</div>
                <div class="#vColDE2#">
            ...
            <div class="row h5">
                <div class="#vColDP12#">
                    <strong>
                        ...
                        <cfelseif #solicitud_status# EQ '5'>
                        ...
                        <cfelseif #solicitud_status# EQ '6'>
                            ...
                            <p class="h6">
                                <strong>Se recibi&oacute; la solicitud y se envi&oacute; notificaci&oacute;n de acuse de recibo por correo electr&oacute;nico con fecha #LsDateFormat(fecha_acuse,'dd - mmmm - yyyy')#</strong>
                            </p>
                        </cfif>
                    </strong>
                </div>
...
<div class="modal-footer">
    <cfoutput>
        <cfif #Session.sTipoSistema# EQ 'stctic' AND #Session.sUsuarioNivel# EQ 0>
            <cfif #tbSolCoa.solicitud_status# EQ '' OR #tbSolCoa.solicitud_status# LTE '1'>
        ...
        <cfif #Session.sTipoSistema# EQ 'stctic' AND #Session.sUsuarioNivel# EQ 0>
            ...
            <cfform id="frmConsSol#vpSolId#" name="frmConsSol#vpSolId#" action="http://www.cic.unam.mx:#CGI.SERVER_PORT#/sistema_solicitudes_registro/" method="POST" target="winSolCoa">
