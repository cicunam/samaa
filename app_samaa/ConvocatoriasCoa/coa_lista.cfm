...
<cfquery name="tbCoas" datasource="#vOrigenDatosSAMAA#">
    ...
    <cfelseif #Session.sTipoSistema# IS 'stctic' AND #vpDepClave# NEQ ''>        
...
<cfif #CGI.SERVER_PORT# EQ '31221'>        
    <cfoutput>#Session.sTipoSistema# - #Session.sIdDep# - #vpDepClave# - #vpNoPlaza# - #vpSsnId# - #vpNoGaceta#</cfoutput>
</cfif>    
