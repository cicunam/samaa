								...
								<div class="well fade in text-center" style="height:300px; background-color:#FFFFFF;">
									<div class="row" align="center">
                                        ...
                                        <div style="width:65%;">
											...
											<div style="width:80%; float:left;" align="left"><h6 style="margin:5px;">Quím. Mariana Luna Barros</h6></div>
                                        </div>
                                        <div style="width:65%;">
                                        	<div style="width:20%; float:left;"><span class="glyphicon glyphicon-envelope"></span></div>
											<div style="width:80%; float:left;" align="left"><h6 style="margin:5px;"><a href="mailto:sectec_ctic@cic.unam.mx">sectec_ctic@cic.unam.mx</a></h6></div>
                                        </div>
                                        <div style="width:65%;">
                                        	<div style="width:20%; float:left;"><span class="glyphicon glyphicon-phone-alt"></span></div>
											<div style="width:80%; float:left;" align="left"><h6 style="margin:5px;">55562-24158 y 55562-24168</h6></div>
                                        </div>
                                        <div style="width:65%;">
