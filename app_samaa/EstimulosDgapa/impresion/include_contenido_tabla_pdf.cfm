...
<!--- INCLUDE CON LA TABLA CON LA RELACIÓN DE ESTÍMULOS PARA LA SESIÓN VIGENTE --->
			...
			<table width="100%" class="tbBorde" border="0" cellspacing="0" cellpadding="0">
				<tr class="tbLineaEncabeza">
					...
					<td class="tbLineaEncabeza" width="20%"><span class="TablaPdfEstDgapa">NOMBRE</span></td>
					<td class="tbLineaEncabeza" width="20%"><span class="TablaPdfEstDgapa">APELLIDOS</span></td>
					...
					<cfif #tbRegistros.orden_samaa# NEQ '3'>
						<td class="tbLineaEncabeza" style="text-align:center;" width="7%"><span class="TablaPdfEstDgapa">DICTAMEN</span></td>
					</cfif>
