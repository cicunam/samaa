<html>
	...
	<body style="padding:15px 25px 15px 25px; width:1024px;">
		<cfoutput>
			...
			<p class="Sans10Gr">
				Favor de copiar la información de arriba y enviarla a la <a href = "mailto:#error.mailTo#">Coordinaci&oacute;n de la Inversigaci&oacute;n Cient&iacute;fica</a> para darle soluci&oacute;n lo antes posible.
			</p>
		</cfoutput>
	</body>
</html>