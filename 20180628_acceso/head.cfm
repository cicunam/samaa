...
<!---
		...
		<table class="Encabezado">
			<tr>
				<!--- Nombre de la UNAM --->
				<td class="EncabezadoUNAM" colspan="3">UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO <cfoutput>#REMOTE_ADDR#</cfoutput></td>
			...
			<tr>
				...
				<cfif IsDefined("Session.sLoginSistema") AND (#Session.sLoginSistema# IS NOT 'pleno' AND #Session.sLoginSistema# IS NOT 'caaa' AND #Session.sLoginSistema# IS NOT 'cbp' AND #Session.sLoginSistema# IS NOT 'inicio')>
					<td class="EncabezadoMenu" colspan="2">
						<a <cfoutput>href="#Application.vCarpetaRaiz#/sistema_ctic/samaa_index.cfm" target="_top"</cfoutput>>MENÚ PRINCIPAL</a>
					</td>
				<cfelse>
