...
<cfif NOT IsDefined("Application.vCarpetaRaiz")>
   	<cflocation url="../invalido.cfm?vError=Restringe" addtoken="no">
<cfelse>
	<!--- Origenes de datos --->
    ...
    <cfset vWebCEUPEID = '#vCarpetaRaizLogicaSistema#/archivos_upeid/'>
<!---    
...
--->
    ...
    <cfif IsDefined('Session.sLoginSistema') AND IsDefined('Session.sTipoSistema')>
    	<cfif #Session.sLoginSistema# NEQ 'ceupeid' AND #Session.sTipoSistema# NEQ 'samaa_ceupeid'>
    ...
    <!---
    <cferror type="exception" template="error.cfm" mailto="samaa@cic-ctic.unam.mx" exception="any">
    --->
