...
<html>
	<head>
		...
		<script type="text/JavaScript">
	        ...
	        {
				<!-- LLAMADO DE INICIO -->
				document.getElementById('mPaC').className = 'MenuEncabezadoBotonSeleccionado';
				fDatosAcademico(); 
				fCalulaAntigAcad();
			}
		</script>
	...
	<body onLoad="fInicioCargaPagina();">
		...
		<table class="Cintillo">
			<tr>
				<td><span class="Sans9GrNe">PERSONAL ACAD&Eacute;MICO &gt;&gt; </span><span class="Sans9Gr">CARGOS ACAD&Eacute;MICO-ADMINISTRATIVOS</span></td>
				<td align="right">
					<span class="Sans9Gr">
		...
		<table width="793" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td width="844" valign="top">
					...
					<!-- Menú -->
					<cfset vTituloModulo = 'CARGOS ACADÉMICO-ADMINISTRATIVOS'>
					<cfinclude template="../include_menus.cfm">
					<!-- Contenido -->
					<table style="width:800px;  margin-left:15px; border:none;" cellspacing="0" cellpadding="1">	
						<!-- Espacio disponible -->
					</table>
