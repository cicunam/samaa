...
<!--- INCLUDE CON LA TABLA CON LA RELACIÓN DE ESTÍMULOS PARA LA SESIÓN VIGENTE --->
			...
			<table class="tbBorde" border="0" cellspacing="0" cellpadding="0">
				<tr class="tbLineaEncabeza">
					...
					<cfif #tbRegistros.orden_samaa# NEQ '3'>
						<td class="tbLineaEncabeza" style="text-align:center;" width="100px"><span class="XlsTablaContenidoEncabeza">DICTAMEN</span></td>
					</cfif>
...
--->
				<cfoutput query="tbRegistros">
                    <tr>
                        ...
                        <td class="tbLineaDerecha" <cfif #orden_samaa# EQ '3'>colspan="2"</cfif>><span class="XlsTablaContenido">#cn_siglas#</span></td>
