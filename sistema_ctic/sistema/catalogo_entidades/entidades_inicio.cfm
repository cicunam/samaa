...
<!--- EDITO: ARAM_PICHARDO --->
<!--- FECHA CREA: 02/04/2018 --->
<!--- FECHA ULTIMA MOD.: 02/04/2018 --->
...
<cfif NOT IsDefined('Session.CatalogoEntidadesFiltro')>
	<!--- Crear un arreglo para guardar la información del filtro --->
	<cfscript>
		CatalogoEntidadesFiltro = StructNew();
		CatalogoEntidadesFiltro.vPagina = '1';
		CatalogoEntidadesFiltro.vRPP = 25;
	</cfscript>
	<cfset Session.CatalogoEntidadesFiltro = '#CatalogoEntidadesFiltro#'>
</cfif>
...
<html>
	<head>
		...
		<cfoutput>
			...
			<script type="text/javascript" src="#vHttpWebGlobal#/jquery/jquery-1.7.2.min.js"></script>
			<script type="text/javascript" src="#vHttpWebGlobal#/jquery/jquery-ui-1.8.21.custom.min.js"></script>
            
			<script type="text/javascript" src="#vHttpWebGlobal#/jquery/jquery.meio.mask.min.js"></script>
            <script type="text/javascript" src="#vHttpWebGlobal#/jquery/jquery.cisic.js"></script>
            <script type="text/javascript" src="#vHttpWebGlobal#/jquery/jquery.truncate.js"></script>
		...
		<script language="JavaScript" type="text/JavaScript">
			...
			function fListarEntidades(vPagina)
			{
				// Icono de espera:
				document.getElementById('catalogoentidades_dynamic').innerHTML = "<img src=\"<cfoutput>#vCarpetaIMG#</cfoutput>/wait.gif\" style=\"display:block; margin:auto;\">";
				// Crear un objeto XmlHttpRequest:
				var xmlHttp = XmlHttpRequest();
				// Función de atención a las petición HTTP:
				xmlHttp.onreadystatechange = function() {
					if (xmlHttp.readyState == 4) {
						document.getElementById('catalogoentidades_dynamic').innerHTML = xmlHttp.responseText;
...
//						document.getElementById('vRegTot_dynamic').innerHTML = document.getElementById('vRegTot').value;
				...
				xmlHttp.open("POST", "entidades_lista.cfm", true);
...
--->		
	...
	<body onLoad="fListarEntidades(1);">
			...
			<tr>
				...
				<td width="180" valign="top" class="bordesmenu">
					...
					<table width="180" border="0">
						...
						<cfmodule template="#vCarpetaRaizLogica#/includes/registros_pagina.cfm" filtro="CatalogoEntidadesFiltro" funcion="fListarEntidades" ordenable="no">
				...
				<td width="844" valign="top">
					<div id="catalogoentidades_dynamic" width="100%"><!-- AJAX: Lista de solicitudes --></div>
