...
<html>
	<head>
		<title><cfif #CGI.SERVER_PORT# IS '31221'>SD / </cfif>SAMAA - Sistema</title>
	...
	<frameset cols="*,1024,*" frameborder="no" framespacing="0">
		...
		<frameset rows="115,*" cols="*" frameborder="no" border="0" framespacing="0">
				<frame src="sistema_head.cfm" name="topFrame" scrolling="no" noresize>
				<frame src="licencias_comisiones/lyc_inicio.cfm" name="mainFrame">
		</frameset>
		<frame src="<cfoutput>#vHttpWebGlobal#</cfoutput>/background.html" scrolling="no" noresize>
	</frameset>
	<noframes> 
