            ...
            <nav class="navbar navbar-default navbar-static">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <span class="navbar-brand" title="Convocatorias de Concurso de Oposición Abierto">
							Convocatorias COA
							<cfoutput>
                    ...
                    <div class="navbar-collapse collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
							<cfoutput query="tbSistemaSubMenu">
            	                <li class="<cfif #submenu_control_id# EQ #vAppConCoaMenu# OR #tbSistemaSubMenu.Recordcount# EQ 1>active</cfif>" id="#submenu_control_id#"><a href="?vAppConCoaMenu=#submenu_control_id#"><strong>#submenu_nombre#</strong></a></li><!---- onClick="fMenuRuta('#submenu_control_id#');" --->
							</cfoutput>
						</ul>
                        <ul class="nav navbar-nav navbar-right">
							<cfoutput>
                                <cfif #Session.sTipoSistema# EQ 'stctic' AND #Session.sUsuarioNivel# EQ 0>
                                    <li title="Reporte números COA´s">
                                        <a href="coa_ennumeros/coa_general_entidad.cfm" target="winCoaNumeros"><span class="glyphicon glyphicon-stats" ></span></a>
                                    </li>
                                </cfif>
								<li title="Guía uso módulos">
                                    <a href="comun/modal_guia.cfm" data-toggle="modal" data-target="##CoaModalGuia">
                                        <span class="glyphicon glyphicon-book" style="color:##FF6600;"></span>
                                    </a>
                                </li>
...
--->								
        ...
        <!--- MODAL GUÍA MÓDULO --->
        <div id="CoaModalGuia" class="modal fade" role="dialog">
