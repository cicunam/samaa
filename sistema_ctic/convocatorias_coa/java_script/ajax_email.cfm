        ...
        <cfmail type="html" from="convocatorias.coa@cic.unam.mx" to="#vEmailConvCoa#" subject="Correo validado y acceder a solicitud electronica COA" username="convocatorias.coa@cic.unam.mx" password="HeeCaCCoa%8282" server="smtp.gmail.com" port="465" useSSL="yes">
            <html>
                ...
                <body>
                    ...
                    <cfif #CGI.SERVER_PORT# IS '31221'>
                        <div class="divLiga" align="center"><a href="http://vectores.cic-ctic.unam.mx:31221/sistema_solicitudes_coa/?TipoSolicitud=C&SistemaSol=05&CoaId=#tbSolicitudes.coa_id#&cvsid=#tbSolicitudes.codigo_num#&cvsan=#tbSolicitudes.codigo_alfanum#" target="winCoa31101">ACCEDER A REGISTRO DE SOLICITUD (SD)</a></div>
                    <cfelse>
                        <div class="divLiga" align="center"><a href="https://solicitudescoa.cic.unam.mx/?TipoSolicitud=C&SistemaSol=05&CoaId=#tbSolicitudes.coa_id#&cvsid=#tbSolicitudes.codigo_num#&cvsan=#tbSolicitudes.codigo_alfanum#" target="winCoa31101">ACCEDER A REGISTRO DE SOLICITUD</a></div>
...
<cfelseif #vpTipoEmail# EQ 'ES'>
    <!--- REENVÍO DE SOLICITUD COLCLUÍDA (29/05/2023) --->    
