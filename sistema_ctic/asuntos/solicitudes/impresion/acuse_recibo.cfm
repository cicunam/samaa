	...
	<html>
		...
		<body>
			...
			<cfquery name="tbSolicitudes" datasource="#vOrigenDatosSAMAA#">
				...
				AND sol_status = 3
				AND movimientos_solicitud.mov_clave <> 40 AND movimientos_solicitud.mov_clave <> 41 <!--- Sin LYC --->
				AND movimientos_solicitud.mov_clave <> 38 <!--- Sin BP --->
				<!--- Ordenamiento --->
			...
			<center>
				...
				<span style="font-size:8pt;"></span>ACUSE DE SOLICITUDES ENVIADAS</span><br>
...
<!--- SE CAMBIÓ EL 07/10/2019 SE RECOMENDÓ POR PARTE DE LA STCTIC DEJAR LAS FECHAS COMO APARECEN EN LAS FORMAS TELEGRÁMICAS
...
--->
						...
						<!-- Fecha de término -->
						<td class="Sans9Gr">
							<cfif #tbSolicitudes.sol_pos15# IS NOT ''><!--- Si el campo no está vacío --->
