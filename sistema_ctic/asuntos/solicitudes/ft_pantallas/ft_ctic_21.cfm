...
<!--- EDITO: ARAM PICHARDO --->
<!--- FECHA: 23/04/2009 --->
<!--- FECHA ÚLTIMA MOD.: 09/08/2019 --->
<!--- FT-CTIC-21.-Año o semestre sabático (sin beca) --->
	...
	<head>
		...
		<script type="text/javascript">
			...
			function fValidaCamposFt()
			{
				var vMensaje = '';
				fLimpiaValida();
				document.getElementById("pos13_box").style.backgroundColor = '#FFFFFF';
				if (!document.getElementById('pos13_1').checked && !document.getElementById('pos13_2').checked)
				{
					vMensaje += 'Campo: TIPO DE PERIODO debe seleccionar una opción.\n';
					document.getElementById("pos13_box").style.backgroundColor = '#FC8C8B';
				}
                    ...
                    <td class="formulario">
                        ...
                        <cfoutput>
                            <table border="0" class="cuadrosFormularios">
                                ...
                                <tr>
                                    <td width="20%"><span class="Sans9GrNe">Tipo de período:</span></td>
                                    <td width="80%" id="pos13_box">
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <cfelse>
                                            <cfinput name="pos21" type="text" class="datos" id="pos21" size="10" maxlength="10" value="#vCampoPos21#" disabled>
                                        </cfif>
                                        <span class="Sans9Gr">#ctMovimiento.mov_pos22# </span>
                                        <cfif #vTipoComando# IS 'IMPRIME'>
                                            <span class="Sans9Gr">#FechaCompleta(vCampoPos22)#</span>
                                        <cfelse>
                                            <cfinput name="pos22" type="text" class="datos" id="pos22" size="10" maxlength="10" value="#vCampoPos22#" disabled>
                                        </cfif>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <cfelse>
                                            <cfinput name="pos15" type="text" class="datos" id="pos15" size="10" maxlength="10" disabled>
                                        </cfif>
                                    </td>
                                </tr>
                        ...
                        <!-- INCLUDE Instituciones donde realizará -->
								...
								<tr>
									<td>
										<span class="Sans9GrNe">
											<!--- #datediff('d', LsDateFormat(tbSolicitudes.sol_fecha_firma,'yyyy-mm-dd'),CreateDate(2019,8,10))# - #LsDateFormat(tbSolicitudes.sol_fecha_firma,'yyyy-mm-dd')# --->
											<!--- CAMBIO DE TEXTO A PARTIR DEL 09/08/2019 A SOLCITUD DE SILVIA VENCES Y AUTORIZADO POR BEATRIZ CRUZ --->
											<cfif vHistoria EQ 1 AND datediff('d', #LsDateFormat(tbSolicitudes.sol_fecha_firma,'yyyy-mm-dd')#, CreateDate(2019,8,10)) GT 0>
												Constancia actualizada de la situación laboral emitida por la DGP
											<cfelse>
												#ctMovimiento.mov_pos37#
											</cfif>
										</span>
									</td>
