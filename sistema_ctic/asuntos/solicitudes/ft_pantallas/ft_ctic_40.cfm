...
<!--- FT-CTIC-40.-Comisión menor a 22 días --->
	...
	<head>
		...
		<script type="text/javascript">
			...
			function actualizar()
			{
				...
				if (document.getElementById('pos12').value == 99) // OTRA ACTIVIDAD
				{
				...
				--->
				// Actualizar el campo de estados:
			...
			function fValidaCamposFt()
			{
				...
				vMensaje += fValidaMenorQue('pos13_d', 22, 'Campo: DURACIÓN no puede exceder los 21 días.\n');
                            ...
                            <!-- Actividades -->
                                <tr>
                                    ...
                                    <td width="80%">
                                        ...
                                        <cfelse>
                                            <cfselect name="pos12" id="pos12" class="datos" query="ctActividad" queryposition="below" value="activ_clave" display="activ_descrip" disabled='#vActivaCampos#' selected="#vCampoPos12#" onchange="actualizar();">
                                ...
                                <tr>
                                    ...
                                    <td width="80%">
                                        ...
                                        <cfelse>
                                            ...
                                            --->
                                            <cfinput name="pos13_d" type="text" class="datos" id="pos13_d" size="2" maxlength="2" disabled='#vActivaCampos#' value="#vCampoPos13_d#" onblur="CalcularSiguienteFecha(); ObtenerTraslapeLicencia(); TieneContratoVigente();" onkeypress="return MascaraEntrada(event, '99');">
                                        ...
                                        <cfelse>
                                            <cfinput name="pos14" type="text" class="datos" id="pos14" size="10" maxlength="10" disabled='#vActivaCampos#' value="#vCampoPos14#" onblur="CalcularSiguienteFecha(); ObtenerTraslapeLicencia(); TieneContratoVigente();" onkeypress="return MascaraEntrada(event, '99/99/9999');">
                                        </cfif>
                                        <span class="Sans9Gr">#ctMovimiento.mov_pos15# </span>
                                        <cfif #vTipoComando# IS 'IMPRIME'>
                                            <span class="Sans9Gr">#FechaCompleta(vCampoPos15)#&nbsp;</span>
                                        <cfelse>
                                            <cfinput name="pos15" type="text" class="datos" id="pos15" size="10" maxlength="10" disabled value="#vCampoPos15#">
                                        </cfif>
                                    </td>
                                </tr>
                            <!-- Lugar (país) -->
