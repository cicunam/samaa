...
<html>
	...
	<body>
		...
		<cfquery name="tbSolicitudes" datasource="#vOrigenDatosSAMAA#">
			...
			AND movimientos_solicitud.sol_pos11_p = 'MEX' <!--- Solo nacionales --->
			ORDER BY 
			C2.dep_orden,
				...
				<cfoutput group="dep_orden">
					...
					<cfoutput>
						<tr>
							...
							<td><cfif #tbSolicitudes.sol_pos11_e# IS 'DF'>M&Eacute;XICO, D.F.<cfelse>#Trim(tbSolicitudes.sol_pos11_c)#, #Trim(ctEstado.edo_nombre)#, M&Eacute;XICO.</cfif></td>
						</tr>
					</cfoutput>
					<!--- División --->
