...
<!--- SQL ORIGINAL YA QUE NO SE RQUIEREN TANTOS JOIN'S
	SELECT * FROM (((((movimientos_solicitud AS T1
	LEFT JOIN movimientos_asunto AS T2 ON T1.sol_id = T2.sol_id AND T2.asu_reunion = 'CTIC')
		...
		<cfelseif #tbSolicitudes.dec_super# IS 'OB' OR #tbSolicitudes.dec_super# IS 'PE'>
			...
			<cfif #tbMovAsuntoCoteja.vCuenta# EQ 0>
                ...
                <cfquery datasource="#vOrigenDatosSAMAA#">
                    ...
                    VALUES (#tbSolicitudes.sol_id#, #vActaPosterior#, 'CAAA', #ReasignarSeccionEnListado(tbSolicitudes.dec_super, tbSolicitudes.asu_parte)#, #Iif(tbSolicitudes.asu_numero IS '',0,tbSolicitudes.asu_numero)#)
                </cfquery>
                ...
                <cfif #tbSolicitudes.dec_clave# IS 24>
                    ...
                    <cfquery datasource="#vOrigenDatosSAMAA#">
                        ...
                        VALUES (#tbSolicitudes.sol_id#, #vActaPosterior#, 'CTIC', #ReasignarSeccionEnListado(tbSolicitudes.dec_super, tbSolicitudes.asu_parte)#, #Iif(tbSolicitudes.asu_numero IS '',0,tbSolicitudes.asu_numero)#, '#tbSolicitudes.asu_oficio#')
                    </cfquery>
			...
			<cfif #tbSolicitudes.mov_clave# IS NOT 31>
				...
				<cfquery datasource="#vOrigenDatosSAMAA#">
					...
					<cfelseif #tbSolicitudes.mov_clave# IS 5 ><!--- Para COA, se separó del IF de arriba para poner la fecha del campo sol_pos14 + 1 año (05/09/2018)--->
						 '#LsDateFormat(DateAdd("yyyy",1,tbSolicitudes.sol_pos14),"dd/mm/yyyy")#'
...
<cfoutput>
	<div class="Sans10Ne" style="width:800px; margin: 10px 0px 10px 15px; border: none">
		<span class="Sans11NeNe" >Informe de registro de movimientos del ACTA #vActa#:<br></span>
		<hr>
		<ul>
...
--->
	...
	<cfelseif #aSD# IS 'PE'><!--- Pendientes por ausencia --->
		...
		<cfelseif Val(#aPT#) EQ 4.2>
			<cfreturn 4.2>
		<cfelseif Val(#aPT#) EQ 5><!--- SE AGREGÓ EL 21/10/2022 --->
			<cfreturn 2.5>
<!---                
        <cfelse>
			<cfreturn 7>
