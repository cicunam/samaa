...
<!--- CÓDIGO PARA EL ENVÍO DE CORREO ELECTRÓNICO DE NOTIFICACIÓN DE RANUANCIA DE BECA POSDOC --->
		...
		<cfif #CGI.SERVER_PORT# EQ '31221'>
            ...
            <cfset vLigaAcuseNotifica = "http://vectores.cic-ctic.unam.mx:31221">
		<cfelseif #CGI.SERVER_PORT# EQ '31220'>
            ...
            <cfset vCorreosEnvio[2][1] = "paty@cic.unam.mx">
            <cfset vCorreosEnvio[2][2] = "Patricia Cortes">
            <cfset vCorreosEnvio[2][3] = "809250">                
            <cfset vCorreosEnvio[3][1] = "samaa@cic.unam.mx">
            <cfset vCorreosEnvio[3][2] = "SAMAA">
            <cfset vCorreosEnvio[3][3] = "999999">
            <cfset vLigaAcuseNotifica = "http://samaa.cic.unam.mx:31220">
		</cfif>
<!---
		<cfset vCorreosEnvio[3][1] = "alejandro.moran@cic.unam.mx">
        <cfset vCorreosEnvio[3][2] = "Mtro. Alejandro Moran">
        ...
        BAJA EL 22/11/2022 Y SE SUSTITUYE POR SAMAA
...
--->
        ...
        <cfloop index="i" from="1" to="#ArrayLen(vCorreosEnvio)#">
            ...
            <cfmail type="html" to="#vCorreosEnvio[i][1]#" from="samaa@cic.unam.mx" subject="Notificacion de RENUNCIA a beca posdoctoral UNAM" username="samaa@cic.unam.mx" password="HeEaSamaa%8282" server="smtp.gmail.com" port="465" useSSL="yes" charset="iso-8859-1">
                ...
                <p>
					...
					<a href="#vCarpetaRaiz#/includes/notifica_correo_solicitud.cfm?vSolId=#vSolId#&vEmpId=#vCorreosEnvio[i][3]#&vCodVerifica=#tbSysClaves.clave_alfanum#" target="WinSAMAANotifica">
