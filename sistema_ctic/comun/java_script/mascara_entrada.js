...
<!-- FECHA CREA: 13/05/2009 -->
<!-- FECHA ÚLTIMA MOD.: 15/03/2019 -->
<!-- FUNCION QUE VALIDA QUE UN CAMPO NO ESTÉ VACÍO -->
<!-- SE AGRAGÓ LA X PARA PERMITIR TODOS LOS CARACTERES 15/03/2019 -->
	...
	function MascaraEntrada(e, mascara) 
	{
		...
		if (filtro == "X" && ((codigo >= 48 && codigo <= 57) || (codigo >= 65 && codigo <= 90) || (codigo >= 97 && codigo <= 122))) return true; // TODOS		
		// Sino, no pasa!
		return false;	 
	}