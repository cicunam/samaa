...
<!--- Cuenta los días ocupados por LICENCIAS menores a 22 días en MOVIMIENTOS --->
...
<!--- Cuenta los días ocupados por LICENCIAS menores a 22 días en SOLICITUDES (25/07/2019) --->
...
<!--- Cuenta los días ocupados por COMISIONES menores a 22 días en MOVIMIENTOS--->
...
<!--- Cuenta los días ocupados por COMISIONES menores a 22 días en SOLICITUDES (25/07/2019) --->
                              ...
                              <td width="60%" height="18px">
									<span class="Sans10ViNe">
										...
										<cfif #dbSolLicencias.vDiasLic# GT 0>
											<div style="float:left; width:85%; cursor:pointer;" title="Consultar solicitudes con días">+ #dbSolLicencias.vDiasLic# días de solicitudes en proceso</div>
										</cfif>
                                  </span>
                              </td>
                          </tr>
                          <tr bgcolor="##F6F6F6">
								...
								<td>
									...
									<cfif #dbSolComisiones.vDiasCom# GT 0>
										<div style="float:left; width:85%; cursor:pointer;" title="Consultar solicitudes con días">+ #dbSolComisiones.vDiasCom#  días de solicitudes en proceso</div>
									</cfif>
                                  </span>
								</td>
							</tr>
                            ...
                            <tr>
                                <td colspan="2" align="center" style="padding-top: 10px;">
                                    <cfform id="frmInfAcad" method="post" action="#vLigaInformacionAcad#" target="winConsultas">
                                        <div class="divInformacionAcad" onclick="document.forms['frmInfAcad'].submit();" title="Consultar la información reportada en la plataforma CISIC">
                                            CONSULTAR INFORMACIÓN ACADÉMICA REPORTADA EN CISIC
