...
<cftry>
	...
	<cfif #vTipoSolicitudAntigCnn# EQ 'N' OR #vTipoSolicitudAntigCnn# EQ 'A'>
        ...
        <cfquery name="tbAcademico" datasource="#vOrigenDatosSAMAA#">
            SELECT acd_id, con_clave, cn_clave, fecha_cn 
            FROM academicos
        ...
        <cfif #tbAcademico.con_clave# EQ 1 OR #tbAcademico.con_clave# EQ 2>
            <!--- DEFINITIVOS E INTERINOS (06/01/2023) --->
            <cfset vDiasAntig = vDiasAntig + #DateDiff('d',tbAcademico.fecha_cn, vFF)#>            
        <cfelseif #tbAcademico.con_clave# EQ 3>
            <!--- PARA LAS OBRAS DETERMINADAS --->
	...
	<cfelseif #vDiasAntig# LTE 0 AND #vSolId# GT 0>
		<cfif #vTipoSolicitudAntigCnn# EQ 'N' OR #vTipoSolicitudAntigCnn# EQ 'C'>
            <cfset vCampoPos4_txt = ''><!--- 1 día SE ELIMINÓ ESTE DATO EL 17/06/2022 --->
            <cfset vCampoPos4 = ''><!--- 1 día SE ELIMINÓ ESTE DATO EL 17/06/2022--->
        <cfelseif #vTipoSolicitudAntigCnn# EQ 'A'>
            <cfquery datasource="#vOrigenDatosSAMAA#">
                UPDATE movimientos_solicitud SET
                sol_pos4 = 1
