		...
		<body>
			...
			<cfdocumentitem type="header">
                ...
                <table border="0" cellspacing="1" cellpadding="1" style="width:100%;">
                    <!-- Línea -->
                    <tr><td colspan="7" height="3px;"><hr class="LineaHr"></td></tr>
                    <!-- Encabezados -->
                    <tr valign="middle">
                        <td style="width:12%;" class="TablaEncabeza">A&ntilde;o de informe</td>
                        <td style="width:30%;" class="TablaEncabeza">Nombre</td>
                        <td style="width:20%;" class="TablaEncabeza">Clase, categor&iacute;a y nivel</td>
                        <td style="width:8%;" class="TablaEncabeza">Entidad</td>
                        <td style="width:10%;" class="TablaEncabeza">Acta</td>
                        <td style="width:10%;" class="TablaEncabeza">N&uacute;mero de oficio</td>
                        <td style="width:10%;" class="TablaEncabeza">Decisión CTIC</td>
                    </tr>
                    <!-- Línea -->
                    <tr><td colspan="7" height="3px;"><hr class="LineaHr"></td></tr>
                </table>
			...
			<table border="0" cellspacing="1" cellpadding="1" style="width:100%;">
				<cfoutput query="tbInformesAnual"> 			
					<tr>
                        <td style="width:12%;" class="TablaContenido">#informe_anio#</td>
                        <td style="width:30%;" class="TablaContenido">#nombre_comp#</td>
                        <td style="width:20%;" class="TablaContenido">#cn_siglas#</td>
                        <td style="width:8%;" class="TablaContenido">#dep_siglas#</td>
                        ...
                        <td style="width:10%;" class="TablaContenido" align="center">#dec_descrip#</td>
					</tr>
				</cfoutput>
			</table>
