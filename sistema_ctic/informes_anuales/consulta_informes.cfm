	...
	<head>
		...
		<script language="JavaScript" type="text/JavaScript">
			...
			function fListarInformes(vPagina, vOrden, vOrdenDir)
			{
                ...
                if ($("#informe_status").val() == 0)
                {vLigaxmlHttp = 'lista_informes_sic.cfm'}
                else
                {vLigaxmlHttp = 'lista_informes.cfm'}
				// Generar una petición HTTP: se especifica si son sincronicas(false) o asincronicas(true) las peticiones 
				xmlHttp.open("POST", vLigaxmlHttp, true);
					...
					<table width="180" border="0">
						...
						<tr>
							<td valign="top">
								<div align="left" class="Sans10NeNe">MEN&Uacute;</div>
                                    <cfoutput>                                
                                        <input type="#vTipoInput#" id="informe_status" name="informe_status" value="#vInformeStatus#">
								        <input type="#vTipoInput#" id="vInformeAnio" name="vInformeAnio" value="#Session.InformesFiltro.vInformeAnio#">
                                    </cfoutput>
								<br>
							</td>
						</tr>
						...
						<cfif #vInformeStatus# LTE 1>
							...
							<cfif #Session.sTipoSistema# EQ 'sic'>
                                ...
                                <tr>
                                    <td><input type="button" value="Imprimir listado para acuse" class="botones" onClick="fImprimirAcuseEntidades();"></td>
                                </tr>
						        <tr><td><br/></td></tr>
						        <tr><td><div class="linea_menu"></div></td></tr>
                                <tr>
                        ...
                        <tr>
                            <td valign="top">
                            <select name="vDecClave" id="vDecClave" class="datos" onChange="<cfoutput>fListarInformes(#Session.InformesFiltro.vPagina#, '#Session.InformesFiltro.vOrden#', '#Session.InformesFiltro.vOrdenDir#'</cfoutput>);">
