...
<!--- EDITÓ: ARAM PICHARDO --->
<!--- FECHA: 19/03/2014 --->
<!--- Imprime lista de becarios posdoctorales que vence su primera beca --->
            ...
            <cfdocumentitem type="header">
                ...
                <center>
                    <span style="font-size:9pt;">
                        ...
                        <br><br>
                        <i>RELACIÓN DE BECARIOS POSDOCTORALES CON PRIMERA BECA POR FINALIZAR</i>
                        <br>
                        <br>
                    </span>
                </center>
